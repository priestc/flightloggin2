/*!
 * Retro Style Countdown Clock - epiClock Rendering Engine
 *
...
(function($){
	...
	$.extend($.epiclocks, {
		retroCountdown: {
			mode: EC_COUNTDOWN,
			stylesheet: 'clocks/retro.countdown.css',
			containerClass: 'epiclock-retro-countdown',
			format: 'V:x:i:s',
			tpl: '<div></div>',
			innerTpl: '<div class="epiclock-img"></div>',
			onSetup: function(){
				$('.epiclock-retro-countdown .epiclock-img').live('flip-clock', function(){
					var el = $(this);
					setTimeout(function(){ 
